...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    if(player_score<opponent_score and (opponent_score - player_score)<=2):
        return True
    else:
        return False
    # END PROBLEM 4b
    ...
    def say(score0, score1):
        if who == 0:
            ...
            if score > running_high:
                print(score,'point(s)! The most yet for Player',0)    
            return announce_highest(who,score0,max(running_high,score)) 
        elif who == 1:
            score = score1 - last_score
            if score > running_high:
                print(score,'point(s)! The most yet for Player',1)     
            return announce_highest(who,score1,max(running_high,score))
    return say 
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=100):
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    sc = free_bacon(opponent_score)
    if extra_turn(score+sc,opponent_score):
        return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return extra_turn_strategy(score,opponent_score,10,5)
    # END PROBLEM 12
